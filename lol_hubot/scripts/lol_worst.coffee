...
#
# Commands:
#   worst <handle> - return the champions with the lowest win/loss ratio for a player. **Options:**  --season: one of [2015, 2014, 3]**  --region: country code**  --verbose (-v): List all champions w/l record in ascending order

_ = require 'underscore'

module.exports = (robot) ->

  robot.hear /^worst (\w*)/i, (msg) ->
    ...
    # not a typo, worst uses the best endpoint
